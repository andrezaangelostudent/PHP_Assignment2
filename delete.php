...
<link href="https://fonts.googleapis.com/css2?family=Koulen&display=swap" rel="stylesheet">
    ...
    <h4>Your profile was successfully deleted!</h4> <!-- the heading -->
    <br><br><!--space between text--> 
    <br>
    <p>In case you prefer you can create another profile in our system.<p>
    <br>
    <!--class with image-->
    <div class="modify">
        <img src="images/delete.jpg" alt="picture">
           </div>
